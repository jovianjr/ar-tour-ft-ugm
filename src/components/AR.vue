      ...
      async (newVal, oldVal) => {
        ...
        loader.load(
          ...
          function (gltf) {
            newVal.path.forEach((e) => {
              arjs.add(gltf.scene.clone(), e[0], e[1])
            })
          },
          function (xhr) {
        ...
        loader.load(
          ...
          function (gltf) {
            ...
            arjs.add(gltf.scene, newVal.target[0], newVal.target[1])
          },
          function (xhr) {
            console.log((xhr.loaded / xhr.total) * 100 + '% loaded')
          },
        ...
        // arjs.add(new THREE.Mesh(targetMarkPoint, targetMaterial), newVal.target[0], newVal.target[1])
      },
      { immediate: true }
    )
  })
